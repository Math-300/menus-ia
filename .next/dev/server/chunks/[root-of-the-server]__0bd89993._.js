...
"[project]/src/app/api/admin/dishes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { name, description, price, image_url, category_id, available, dietary, is_popular, is_chef_choice, is_new } = body;
        ...
        // Create dish
        const { data: dish, error: createError } = await supabase.from('dishes').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bd89993._.js.map