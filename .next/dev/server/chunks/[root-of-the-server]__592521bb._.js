...
async function POST(request) {
    try {
        ...
        const { title, type, image_url, video_url, linked_dish_id, is_active, expires_at } = body;
        ...
        // Create story
        const { data: story, error: createError } = await supabase.from('stories').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__592521bb._.js.map