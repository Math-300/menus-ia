...
import { chatWithConcierge } from '@/lib/ai/chatService';
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 no-scrollbar bg-gradient-to-b from-transparent to-black/20">
            ...
            {messages.map(msg => (
              <div key={msg.id} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div
                  className={`max-w-[85%] rounded-2xl p-4 text-sm font-light leading-relaxed shadow-lg backdrop-blur-md ${msg.role === 'user'
